  ...
  Object.defineProperty(Vue.prototype, '$t', {
    get: function get () {
      ...
      return function (key, defaultVal) {
        ...
        var ret = i18n._t.apply(i18n, [key, i18n.locale, i18n._getMessages(), this$1])//.concat( values ))
        return ret == key ? defaultVal : ret
      }
    }
  })
  // $FlowFixMe
...
function install (_Vue) {
  ...
  /* istanbul ignore if */
  if ('production' !== 'production' && install.installed) {
...
VueI18n.prototype._warnDefault = function _warnDefault (locale, key, result, vm, values) {
  ...
  if (this._missing) {
    ...
    if ('production' !== 'production' && !this._silentTranslationWarn) {
      warn(
...
VueI18n.prototype._interpolate = function _interpolate (locale,
                                                        message,
                                                        key,
                                                        host,
                                                        interpolateMode,
...
VueI18n.prototype._link = function _link (locale,
                                          message,
                                          str,
                                          host,
                                          interpolateMode,
  ...
  for (var idx in matches) {
    ...
    if (this$1._isFallbackRoot(translated)) {
      if ('production' !== 'production' && !this$1._silentTranslationWarn) {
...
VueI18n.prototype._translate = function _translate (messages,
                                                    locale,
                                                    fallback,
                                                    key,
                                                    host,
...
VueI18n.prototype._tc = function _tc (key,
                                      _locale,
                                      messages,
                                      host,
                                      choice) {
...
VueI18n.prototype._localizeDateTime = function _localizeDateTime (value,
                                                                  locale,
                                                                  fallback,
                                                                  dateTimeFormats,
                                                                  key) {
...
VueI18n.prototype._localizeNumber = function _localizeNumber (value,
                                                              locale,
                                                              fallback,
                                                              numberFormats,
                                                              key,
...
VueI18n.prototype._n = function _n (value, locale, key, options) {
  /* istanbul ignore if */
  if ('production' !== 'production' && !VueI18n.availabilities.numberFormat) {
